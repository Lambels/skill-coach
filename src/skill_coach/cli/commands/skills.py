    ...
    def run(self, args, conn) -> list[Section]:
        ...
        return [Section(
            ...
            columns=[
                ...
                ("avg_tokens",           "avg",       fmt_avg_int,      "right", "dim"),
                ...
                ("total_output",         "out",       fmt_int,          "right", "dim"),
                ("total_uncached_input", "in",        fmt_int,          "right", "dim"),
                ("total_cache_read",     "cache_r",   fmt_int,          "right", "dim"),
                ("total_cache_creation", "cache_c",   fmt_int,          "right", "dim"),
                ("slash_calls",          "slash",     fmt_int,          "right", "dim"),
                ("tool_calls",           "tool",      fmt_int,          "right", "dim"),
            ],
            default_columns=["skill", "n", "tokens", "cost", "cache", "dur", "reqs", "via"],
        )]
